...
Devise.setup do |config|
  ...
  # config.secret_key = 'b496aae1833d1f54d5cd30459ecfdfe210a821ae55a7bde6ca1a632b9f5e42bd9fb6042393afa826ffc6b38afeb5be7de284d7cd112138e9fc3a1897b53a7a8c'
  ...
  if Rails.env.production?
    raise 'not for deployment'
  else # Rails.env.test? || Rails.env.development?
    config.cas_base_url = 'http://cas:8181'
  end

  # you can override these if you need to, but cas_base_url is usually enough
  # config.cas_login_url = "https://cas.myorganization.com/login"
  # config.cas_logout_url = "https://cas.myorganization.com/logout"
  config.cas_validate_url = "#{config.cas_base_url}/serviceValidate"
  ...
  config.cas_enable_single_sign_out = false
  ...
  # config.pepper = 'd4ef16723d6120de05b96a116a9eaadfb44d58dcf3d387ca6eea3893a6fd932b427ad51d03c465bf3a273fc9fbd1d6f1cbe4240412db841901958946df480eb5'
